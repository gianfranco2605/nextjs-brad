...
async function sharedHaikuLogic(formData, user) {
  ...
  if (ourHaiku.line1.length < 7) errors.line2 = "Too few syllables, must be 7";
  if (ourHaiku.line1.length > 35)
    errors.line2 = "Too many syllables, must be 7";

  if (ourHaiku.line1.length < 5) errors.line3 = "Too few syllables, must be 5";
  if (ourHaiku.line1.length > 25)
